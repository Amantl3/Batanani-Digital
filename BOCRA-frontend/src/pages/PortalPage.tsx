...
import {
  ...
  Bell, ChevronRight, AlertCircle, Clock,
} from 'lucide-react'
        ...
        <div className="container-page">
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex gap-3">
              ...
              <button className="btn-sm rounded-lg border border-white/20 text-white/80 hover:border-white/40 px-4">
      ...
      <div className="container-page grid gap-6 py-8 lg:grid-cols-[1fr_300px]">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
              {SERVICES.map(s => (
                <Link
                  key={s.key}
                  to={s.to}
                  className="card group flex items-start gap-4 p-4 transition-all hover:-translate-y-0.5 hover:border-bocra-blue/30 hover:shadow-card-md"
                >
        ...
        <div className="space-y-4">
          ...
          <div className="card">
            ...
            <div className="divide-y divide-slate-100">
              {NOTIFICATIONS.map(n => (
                <div key={n.id} className={cn('px-4 py-3', !n.read && 'bg-blue-50/40')}>
          ...
          <div className="card">
            ...
            <div className="card-footer text-center">
              <button className="text-xs text-bocra-blue hover:underline">{t('portal.view_payments')}</button>
            </div>
          </div>
